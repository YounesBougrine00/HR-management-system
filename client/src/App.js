...
export default class App extends Component {
    render() {
        return ( <
            ...
            /> <
            Route exact path = "/empDashboard"
            component = { EmpDashboard }
            /> <
            Route exact path = "/otherRequest"
            component = { OtherRequests }
            /> <
            Route exact path = "/mySalDetails"
            component = { MySalDetails }
            /> <
            Route exact path = "/companyInfo"
            component = { CompanyInfo }
            /> <
            Route exact path = "/viewSingleRequest/:title/:reqId"
            ...
            /> <
            Route exact path = "/activeLoans"
            component = { ActiveLoans }
            /> <
            Route exact path = "/editEmpProfile/:id"
