        ...
        <div className="col">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col">
                <h6 className="text-right">MAD {basicPay}</h6>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col">
                <h6 className="text-right">MAD {medicalAllowance}</h6>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col">
                <h6 className="text-right">MAD {travelAllowance}</h6>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col">
                <h6 className="text-right">MAD {bonus}</h6>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col">
                <h4 className="text-right">MAD {salary}</h4>
              </div>
            </div>
          </div>
        </div>
